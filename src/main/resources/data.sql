-- User 데이터 입력
-- id: user1~4, password: user
-- id: admin@example.com pw: admin
insert into users (password, name, phone, email)
values ('$2a$10$k8ZGBju91b9sDEhUuHUrieckHdj1G.wGwXTRoRW8uNdR5K1qSvnBq', 'user', '010-1234-5678', 'user@example.com'),
       ('$2a$10$k8ZGBju91b9sDEhUuHUrieckHdj1G.wGwXTRoRW8uNdR5K1qSvnBq', 'user1', '010-1234-5678', 'user1@example.com'),
       ('$2a$10$k8ZGBju91b9sDEhUuHUrieckHdj1G.wGwXTRoRW8uNdR5K1qSvnBq', 'user2', '010-1234-5678', 'user2@example.com'),
       ('$2a$10$k8ZGBju91b9sDEhUuHUrieckHdj1G.wGwXTRoRW8uNdR5K1qSvnBq', 'user3', '010-1234-5678', 'user3@example.com'),
       ('$2a$10$k8ZGBju91b9sDEhUuHUrieckHdj1G.wGwXTRoRW8uNdR5K1qSvnBq', 'user4', '010-1234-5678', 'user4@example.com'),
       ('$2a$10$mGTA5LpWNesicgOKrzMFJOahigX1cf9fywfXsw2f8rYqQI6zBsYSi', '관리자', '010-0000-0000', 'admin@example.com');
...
-- 
--  insert into hotel_image (HOTEL_IDX, IMAGE)
...
--  insert into hotel_room_type (HOTEL_IDX, NAME, DESCRIPTION, PRICE, DISCOUNT, PEOPLECOUNT, BEDSIZE, ROOMSIZE)
--  values (1, '그랜드 디럭스 룸',
--          '우아한 인테리어와 현대적 세련미가 조화롭게 어우러진 시그니엘 서울의 그랜드 디럭스 룸은 초고층 객실에서 바라보는 서울 도심의 파노라믹뷰와 최상의 휴식을 제공합니다.'
--             , 600000, 0, 2, 2, 45);
--  insert into hotel_room_type_images(roomType_IDX, image)
