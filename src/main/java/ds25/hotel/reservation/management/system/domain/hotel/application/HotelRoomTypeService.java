...
import ds25.hotel.reservation.management.system.ui.dto.hotel.HotelRoomTypeImageDto;
...
public class HotelRoomTypeService {
    ...
    @Inject
    public HotelRoomTypeService(HotelRoomTypeRepository hotelRoomTypeRepository, UserRepository userRepository, HotelRepository hotelRepository) {
    ...
    public HotelRoomTypeDto addHotelRoomType(HotelRoomTypeDto hotelRoomTypeDto) throws Exception {
        ...
        if (hotelRoomTypeDto.getName().isBlank()) {
    ...
    public HotelRoomTypeDto modifyHotelRoomType(HotelRoomTypeDto hotelRoomTypeDto) throws Exception {
        ...
        if (hotelRoomTypeDto.getBedType() != null) {
            oldHotelRoom.get().setBedType(hotelRoomTypeDto.getBedType());
        }
