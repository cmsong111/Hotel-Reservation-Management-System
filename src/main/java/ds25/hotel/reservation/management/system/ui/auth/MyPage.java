...
public class MyPage extends JFrame implements ActionListener {
    ...
    UserDto user = AppConfig.getInstance().getUser();
    HotelReservationService hotelReservationService = DiContext.getInstance().getComponent(HotelReservationService.class);
